...
**Status:** 🟢 Pipeline built · 🟢 Fine-tuned (WER 108.18%→28.79% on DODa) · model on HF Hub (`Amassu/whisper-small-darija`) · 🟢 wired into TDD-06 backend (`LOAD_STT=true`)
...
- [x] Wire `WhisperTranscriber` into `/transcribe` (TDD-06) via `LOAD_STT=true`
